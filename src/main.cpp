...
// configuration step. It creates a namespace called `mattris`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        mattris::cmake::project_name,
        mattris::cmake::project_version));// version string, acquired
